...
class BERTOPIC:
    ...
    def embed(self):
        ...
        self.embedding_model = SentenceTransformer('paraphrase-MiniLM-L6-v2', device='cuda')     # gpu
        ...
        if os.path.exists(self.embeddings_path_cpu):
            ...
            self.embeddings = self.embedding_model.encode(self.text_with_stopwords, convert_to_tensor=True)  # gpu
            self.embeddings_cpu = self.embeddings.cpu().numpy()   # cpu
